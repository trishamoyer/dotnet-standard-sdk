...
namespace IBM.WatsonDeveloperCloud.VisualRecognition.v3
{
    public interface IVisualRecognitionService
    {
        ...
        /// <param name="parameters">A string representation of a JSON object that specifies a single image to analyze by URL. The parameter can be sent as a string or a file.  Example: `{"url":"http://www.example.com/images/myimage.jpg"}`. (optional)</param>
        /// <param name="imagesFileContentType">The content type of imagesFile. (optional)</param>
